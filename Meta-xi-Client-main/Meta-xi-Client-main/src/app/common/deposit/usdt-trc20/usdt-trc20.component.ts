...
@Component({
  selector: 'app-usdt-trc20',
  standalone: true,
  imports: [CommonModule, RouterLink, FormsModule],
  templateUrl: './usdt-trc20.component.html',
  styleUrl: './usdt-trc20.component.scss',
})
export class UsdtTrc20Component implements OnInit {
  readonly MIN_AMOUNT = 10;
  readonly CONVERSION_RATE = 3600; // USDT to COP

  // Wallet & User
  walletAddress = environment.usdtTrc20WalletAddress;
  ...
  confirmAmount(): void {
    ...
    this.router.navigate(['/deposit', 'usdt-trc20'], {
  ...
  handleQrError(event: Event): void {
    ...
    if (img) {
      img.src = 'assets/token/usdt-trc20.png';
    }
  }
